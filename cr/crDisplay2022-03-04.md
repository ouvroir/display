...
Pas encore de dispositif pour citer / référencer ni autre, développements en interne donc l'outil peut encore évoluer. 
...
montrer le musée pour pouvoir le remettre en question / poser un regard critique (moins d'urgence pour un musée contemporain, mais pour les musées qui ont instrumentalisé leurs collections, musées encyclopédiques placent la connaissance avant l'œuvre, <!--l'œuvre est au service du récit?--> )

période vraiment particulière pour le musée
